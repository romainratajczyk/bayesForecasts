...
model {
  ...
  // Ordre réel de X_VOL_COLS (K_v = 9) :
  //  1 log_D_ij | 2 log_D_ij_sq | 3 LB_ij | 4 OL_ij | 5 COL_ij
  //  6 v2x_polyarchy_o_lag5 | 7 intensity_level_o_lag5
  //  8 v2x_clphy_d_lag5     | 9 intensity_level_d_lag5
  beta_grav[1]     ~ normal(-0.5, 0.5);
  beta_grav[2]     ~ normal(-0.5, 0.5);
  beta_grav[3:5]   ~ normal(0, 2.0);
  beta_grav[6:K_v] ~ normal(0, 1.0);
  ...
  omega_raw ~ normal(1.5, 1);      // centre ~0.82
